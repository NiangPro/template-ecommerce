                            ...
                            <table class="table table-cart table-mobile">
                                ...
                                <tbody>
                                    ...
                                    <tr wire:ignore.self>
                                        ...
                                        <td class="remove-col"><button wire:confirm="Êtes-vous sûr de vouloir supprimer ?" wire:click="removeCart({{$c["id"]}})" class="btn-remove"><i class="la la-trash text-danger"></i></button></td>
                                    </tr>
                                    @endforeach
                                </tbody>
