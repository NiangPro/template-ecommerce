           ...
           <div class="d-flex align-items-center">
            ...
            <div class="table-responsive">
                @if($type == "add" || $type == "edit")
                    @include('livewire.admin.tag.add')
                @else
                <table id="example" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        @foreach($tags as $t)
                            <tr >
                                <td class="h5">{{$t->nom}}</td>
                                <td>
                                    <button class="btn btn-outline-info btn-sm radius-30" wire:click="editer({{$t->id}})"><i class="bx bx-show"></i></button>
                                    <button class="btn btn-outline-danger btn-sm radius-30" wire:click="readyForDelete({{$t->id}})" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="bx bx-trash"></i></button>
                                </td>
                            </tr>
