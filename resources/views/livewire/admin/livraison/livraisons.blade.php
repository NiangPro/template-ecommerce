           ...
           <div class="d-flex align-items-center">
            ...
            <div class="table-responsive">
                @if($type == "add" || $type == "edit")
                    @include('livewire.admin.livraison.add')
                @else
...
@section('js')
<script>
    window.addEventListener('addLivraison', event =>{
        iziToast.success({
        title: "Livraison",
        message: "Livraison ajouté avec succès",
        position: 'topRight'
        });
    });

    window.addEventListener('updateLivraison', event =>{
        iziToast.success({
        title: "Livraison",
    ...
    window.addEventListener('deleteLivraison', event =>{
        iziToast.success({
        title: "Livraison",
        message: "Livraison supprimé avec succès",
        position: 'topRight'
        });
